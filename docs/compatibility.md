...
| TIDAL Web                      | Google Chrome           | Smoke tested | Live-tested on GNOME Shell 46 with Chrome browser MPRIS. Chrome exposed complete title, artist, album, duration, playback status, and advancing position for the sampled track; LyricBar selected Chrome over paused Spotify and rendered synced lyrics. Broader TIDAL desktop, wrapper, and browser coverage still needs evidence.             |
